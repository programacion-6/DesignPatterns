...
using Command.ConcreteCommands.GarageDoors;
...
public class Program
{
    public static void Main()
    {
        ...
        ICommand garageDoorOn = new GarageDoorOpenCommand(garageDoor);
        ICommand garageDoorOff = new GarageDoorCloseCommand(garageDoor);
